...
DeclareModule ControlEdit 
  ...
  Declare Event( *Me.ControlEdit_t, ev_code.i, *ev_data.Control::EventTypeDatas_t = #Null )
...
;{
; ---[ Event ]----------------------------------------------------------------
Procedure.i Event( *Me.ControlEdit_t, ev_code.i, *ev_data.Control::EventTypeDatas_t = #Null )
  ; ---[ Retrieve Interface ]-------------------------------------------------
