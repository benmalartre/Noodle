...
Module ViewportUI
  ...
  Procedure New(*parent.View::View_t,name.s, *camera.Camera::Camera_t, *ctx.GLContext::GLContext_t)
    ...
    *Me\context = GLContext::New(w, h,*context)
    *Me\camera = *camera
    ...
    CompilerIf #PB_Compiler_OS = #PB_OS_MacOS  
      ...
      *Me\gadgetID = CanvasGadget(#PB_Any,0,0,w,h)
      ...
      CocoaMessage( 0, GLContext::*MAIN_GL_CTXT\ID, "makeCurrentContext" )
    ...
    CompilerElseIf #PB_Compiler_OS = #PB_OS_Windows
      *Me\gadgetID = *Me\context\ID
      ...
      SetGadgetAttribute(GLContext::*MAIN_GL_CTXT\ID,#PB_OpenGL_SetContext,#True)
    CompilerEndIf
