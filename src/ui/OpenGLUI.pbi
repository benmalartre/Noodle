...
; ============================================================================
;   OpenGLUI Module Declaration
; ============================================================================
DeclareModule OpenGLUI
  UseModule UI
  Structure OpenGLUI_t Extends UI_t
  ...
  Interface IOpenGLUI Extends IUI
  EndInterface

  Declare New(*parent.View::View_t,name.s, *camera.Camera::Camera_t)
  Declare Delete(*Me.OpenGLUI_t)
  Declare Init(*Me.OpenGLUI_t)
  Declare OnEvent(*Me.OpenGLUI_t,event.i)
  Declare Term(*Me.OpenGLUI_t)
  Declare SetContext(*Me.OpenGLUI_t)
  Declare FlipBuffer(*Me.OpenGLUI_t)
  Declare Draw(*Me.OpenGLUI_t, *ctx.GLContext::GLContext_t)
  Declare AddLayer(*Me.OpenGLUI_t, *layer.Layer::Layer_t)
  Declare SetHandleTarget(*Me.OpenGLUI_t, *target.Object3D::Object3D_t)
  Declare SetHandleTargets(*Me.OpenGLUI_t, *targets)
  Declare SetHandleTool(*Me.OpenGLUI_t, tool.i)
  Declare GetRay(*Me.OpenGLUI_t, *ray.Geometry::Ray_t)
  ;Declare SetActiveLayer(*Me.OpenGLUI_t, index.i)
  Declare ViewToWorld(*v.OpenGLUI_t,mx.d,my.d,*world_pos.Math::v3f32)
  Declare ViewToRay(*Me.OpenGLUI_t,mx.f,my.f,*ray_dir.Math::v3f32)
  Declare Project(*v.OpenGLUI_t,*pos.Math::v3f32,*io_pos.Math::v3f32, homogenous.b=#True)
  Declare Unproject(*v.OpenGLUI_t, x.f, y.f,*world_pos.Math::v3f32)
...
; ============================================================================
; OpenGLUI Module Implementation
; ============================================================================
Module OpenGLUI
  UseModule OpenGL
  UseModule OpenGLExt
  UseModule Math
  ;------------------------------------------------------------------
  ; NO CONSTRUCTOR AS IT IS A BASE CLASS
  ;------------------------------------------------------------------
  Procedure New(*parent.View::View_t,name.s, *camera.Camera::Camera_t)
    Protected *Me.OpenGLUI_t = AllocateMemory(SizeOf(OpenGLUI_t))
  ...
  ; Delete
  ;------------------------------------------------------------------
  Procedure Delete(*Me.OpenGLUI_t)
    If IsGadget(*Me\gadgetID) : FreeGadget(*Me\gadgetID):EndIf
    If IsGadget(*Me\container) : FreeGadget(*Me\container):EndIf
    Object::TERM(OpenGLUI)
  EndProcedure

  ;------------------------------------------------------------------
  ; Init
  ;------------------------------------------------------------------
  Procedure Init(*Me.OpenGLUI_t)
    Debug "OpenGLUI Init Called!!!"
  EndProcedure
    
  ;------------------------------------------------------------------
  ; Event
  ;------------------------------------------------------------------
  Procedure OnEvent(*Me.OpenGLUI_t,event.i)
;     SetGadgetAttribute(*Me\gadgetID,#PB_OpenGL_SetContext,#True)
...
;           EndSelect
  ...
  ; Draw
  ;------------------------------------------------------------------
  Procedure Draw(*Me.OpenGLUI_t, *ctx.GLContext::GLContext_t)
  ...
  ; Term
  ;------------------------------------------------------------------
  Procedure Term(*Me.OpenGLUI_t)
    Debug "OpenGLUI Term Called!!!"
  EndProcedure
  
  ;------------------------------------------------------------------
  ; Add Layer
  ;------------------------------------------------------------------
  Procedure AddLayer(*Me.OpenGLUI_t, *layer.Layer::Layer_t)
  ...
  ; Set Handle Target
  ;------------------------------------------------------------------
  Procedure SetHandleTarget(*Me.OpenGLUI_t, *target.Object3D::Object3D_t)
  ...
  ; Set Handle Targets
  ;------------------------------------------------------------------
  Procedure SetHandleTargets(*Me.OpenGLUI_t, *targets)
  ...
  ; Set Handle Tool
  ;------------------------------------------------------------------
  Procedure SetHandleTool(*Me.OpenGLUI_t, tool)
  ...
  ;------------------------------------------------------------------
  Procedure ViewToWorld(*v.OpenGLUI_t,mx.d,my.d,*world_pos.v3f32)
  ...
  ; View To Ray
  ;------------------------------------------------------------------
  Procedure ViewToRay(*Me.OpenGLUI_t,mx.f,my.f,*ray_dir.v3f32)
  ...
  ;  Get Ray
  ; ------------------------------------------------------------------
  Procedure GetRay(*Me.OpenGLUI_t, *ray.Geometry::Ray_t)
  ...
  ;  Ray Pick
  ; ------------------------------------------------------------------
  Procedure RayPick2(*v.OpenGLUI_t)
    Define.d mx,my
  ...
  ; Unproject
  ;-------------------------------------------------------
  Procedure Unproject(*v.OpenGLUI_t, x.f, y.f,*world_pos.v3f32)
    Protected window_pos.v3f32

    Vector3::Set(window_pos,x,*v\sizY-y,0.5)
    Vector3::Echo(window_pos,"Window Pos")
    Protected OpenGL.v4f32
    Vector4::Set(OpenGL,*v\posX,*v\posY,*v\sizX,*v\sizY)
    Vector4::Echo(OpenGL,"OpenGL")
    ...
    _in\x=window_pos\x/OpenGL\z*2.0-1.0;
    _in\y=(window_pos\y-OpenGL\y)/OpenGL\w*2.0-1.0;
  ...
  ;  EndIf
    ...
    ;GL_Unproject(@window_pos,*v\camera\global\GetMatrix(),*v\camera\projection,@OpenGL,*world_pos)
  ...
  ; Project
  ;-------------------------------------------------------
  Procedure Project(*v.OpenGLUI_t,*pos.v3f32,*io_pos.v3f32, homogenous.b=#True)
  ...
  ; Set Context
  ;-------------------------------------------------------
  Procedure SetContext(*v.OpenGLUI_t)
  ...
  ; Flip Buffer
  ;-------------------------------------------------------
  Procedure FlipBuffer(*v.OpenGLUI_t)
    CompilerIf Not #USE_GLFW
      CompilerIf #PB_Compiler_OS = #PB_OS_MacOS And Not #USE_LEGACY_OPENGL
