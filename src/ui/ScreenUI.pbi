...
; ============================================================================
; ScreenUI Module Declaration
; ============================================================================
DeclareModule ScreenUI
  UseModule UI
  Structure ScreenUI_t Extends UI_t
  ...
  Interface IScreenUI Extends IUI
  EndInterface

  Declare New(*parent.View::View_t,name.s, *camera.Camera::Camera_t)
  Declare Delete(*Me.ScreenUI_t)
  Declare Init(*Me.ScreenUI_t)
  Declare OnEvent(*Me.ScreenUI_t,event.i)
  Declare Term(*Me.ScreenUI_t)
  Declare SetContext(*Me.ScreenUI_t)
  Declare FlipBuffer(*Me.ScreenUI_t)
  Declare Draw(*Me.ScreenUI_t, *ctx.GLContext::GLContext_t)
  Declare AddLayer(*Me.ScreenUI_t, *layer.Layer::Layer_t)
  Declare SetHandleTarget(*Me.ScreenUI_t, *target.Object3D::Object3D_t)
  Declare SetHandleTargets(*Me.ScreenUI_t, *targets)
  Declare SetHandleTool(*Me.ScreenUI_t, tool.i)
  Declare GetRay(*Me.ScreenUI_t, *ray.Geometry::Ray_t)
  ;Declare SetActiveLayer(*Me.ScreenUI_t, index.i)
  Declare ViewToWorld(*v.ScreenUI_t,mx.d,my.d,*world_pos.Math::v3f32)
  Declare ViewToRay(*Me.ScreenUI_t,mx.f,my.f,*ray_dir.Math::v3f32)
  Declare Project(*v.ScreenUI_t,*pos.Math::v3f32,*io_pos.Math::v3f32, homogenous.b=#True)
  Declare Unproject(*v.ScreenUI_t, x.f, y.f,*world_pos.Math::v3f32)
...
; ============================================================================
; ScreenUI Module Implementation
; ============================================================================
Module ScreenUI
  UseModule OpenGL
  UseModule OpenGLExt
  ...
  ; Delete
  ;------------------------------------------------------------------
  Procedure Delete(*Me.ScreenUI_t)
    If IsGadget(*Me\gadgetID) : FreeGadget(*Me\gadgetID):EndIf
    If IsGadget(*Me\container) : FreeGadget(*Me\container):EndIf
    Object::TERM(ScreenUI)
  EndProcedure

  ;------------------------------------------------------------------
  ; Init
  ;------------------------------------------------------------------
  Procedure Init(*Me.ScreenUI_t)
    Debug "ScreenUI Init Called!!!"
  EndProcedure
    
  ;------------------------------------------------------------------
  ; Event
  ;------------------------------------------------------------------
  Procedure OnEvent(*Me.ScreenUI_t,event.i)
;     SetGadgetAttribute(*Me\gadgetID,#PB_OpenGL_SetContext,#True)
...
;           EndSelect
  ...
  ; Draw
  ;------------------------------------------------------------------
  Procedure Draw(*Me.ScreenUI_t, *ctx.GLContext::GLContext_t)
  ...
  ; Term
  ;------------------------------------------------------------------
  Procedure Term(*Me.ScreenUI_t)
    Debug "ScreenUI Term Called!!!"
  EndProcedure
  
  ;------------------------------------------------------------------
  ; Add Layer
  ;------------------------------------------------------------------
  Procedure AddLayer(*Me.ScreenUI_t, *layer.Layer::Layer_t)
  ...
  ; Set Handle Target
  ;------------------------------------------------------------------
  Procedure SetHandleTarget(*Me.ScreenUI_t, *target.Object3D::Object3D_t)
  ...
  ; Set Handle Targets
  ;------------------------------------------------------------------
  Procedure SetHandleTargets(*Me.ScreenUI_t, *targets)
  ...
  ; Set Handle Tool
  ;------------------------------------------------------------------
  Procedure SetHandleTool(*Me.ScreenUI_t, tool)
  ...
  ;------------------------------------------------------------------
  Procedure ViewToWorld(*v.ScreenUI_t,mx.d,my.d,*world_pos.v3f32)
  ...
  ; View To Ray
  ;------------------------------------------------------------------
  Procedure ViewToRay(*Me.ScreenUI_t,mx.f,my.f,*ray_dir.v3f32)
  ...
  ;  Get Ray
  ; ------------------------------------------------------------------
  Procedure GetRay(*Me.ScreenUI_t, *ray.Geometry::Ray_t)
...
;   ;  Ray Pick
;   ; ------------------------------------------------------------------
;   Procedure RayPick2(*v.ScreenUI_t)
;     Define.d mx,my
;   
...
;   CompilerEndIf
  ...
  ; Unproject
  ;-------------------------------------------------------
  Procedure Unproject(*v.ScreenUI_t, x.f, y.f,*world_pos.v3f32)
    Protected window_pos.v3f32

    Vector3::Set(window_pos,x,*v\sizY-y,0.5)
    Vector3::Echo(window_pos,"Window Pos")
    Protected Screen.v4f32
    Vector4::Set(Screen,*v\posX,*v\posY,*v\sizX,*v\sizY)
    Vector4::Echo(Screen,"Screen")
    ...
    _in\x=window_pos\x/Screen\z*2.0-1.0;
    _in\y=(window_pos\y-Screen\y)/Screen\w*2.0-1.0;
  ...
  ;  EndIf
    ...
    ;GL_Unproject(@window_pos,*v\camera\global\GetMatrix(),*v\camera\projection,@Screen,*world_pos)
  ...
  ; Project
  ;-------------------------------------------------------
  Procedure Project(*v.ScreenUI_t,*pos.v3f32,*io_pos.v3f32, homogenous.b=#True)
  ...
  ; Set Context
  ;-------------------------------------------------------
  Procedure SetContext(*v.ScreenUI_t)
  ...
  ; Flip Buffer
  ;-------------------------------------------------------
  Procedure FlipBuffer(*v.ScreenUI_t)
    CompilerIf Not #USE_GLFW
      CompilerIf #PB_Compiler_OS = #PB_OS_MacOS And Not #USE_LEGACY_OPENGL
