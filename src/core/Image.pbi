...
DeclareModule Image
  ...
  Declare AllocateImageData (nImage, *BufferPitch.Integer, FillColor = -1)
  Declare CopyImageData (nImage, *DestMem)
  Declare RotateImage (nSrcImage, DegRot)
  Declare RotateImageFree (nSrcImage, fDegRot.f, flgAntiAliasing, FillColor = $ffffff)
  Declare FlipImage (nSrcImage)
  Declare MirrorImage (nSrcImage)
EndDeclareModule
