...
Module Light
  ...
  Procedure Setup(*Me.Light_t,*pgm.Program::Program_t)
    ...
    ;Attach Shader
    If *pgm : *Me\pgm = *pgm : EndIf
    
    Protected shader.i
    If *Me\pgm : shader = *Me\pgm\pgm : EndIf
...
;     Next
  ...
  Procedure New( name.s,type.i=#Light_Infinite)
    ...
    *Me\depthplane = 20
    ...
    Protected *position = Attribute::New(*Me"Position",Attribute::#ATTR_TYPE_VECTOR3,Attribute::#ATTR_STRUCT_SINGLE,Attribute::#ATTR_CTXT_SINGLETON,*Me\pos,#False,#True)
    Object3D::AddAttribute(*Me,*position)
    Protected *lookat = Attribute::New(*Me"LookAt",Attribute::#ATTR_TYPE_VECTOR3,Attribute::#ATTR_STRUCT_SINGLE,Attribute::#ATTR_CTXT_SINGLETON,*Me\lookat,#False,#True)
    Object3D::AddAttribute(*Me,*lookat)
    Protected *up = Attribute::New(*Me"UpVector",Attribute::#ATTR_TYPE_VECTOR3,Attribute::#ATTR_STRUCT_SINGLE,Attribute::#ATTR_CTXT_SINGLETON,*Me\up,#False,#True)
    Object3D::AddAttribute(*Me,*up)
    Protected *fov = Attribute::New(*Me"FOV",Attribute::#ATTR_TYPE_FLOAT,Attribute::#ATTR_STRUCT_SINGLE,Attribute::#ATTR_CTXT_SINGLETON,@*Me\fov,#False,#True)
    ...
    Protected *far = Attribute::New(*Me"farplane",Attribute::#ATTR_TYPE_FLOAT,Attribute::#ATTR_STRUCT_SINGLE,Attribute::#ATTR_CTXT_SINGLETON,@*Me\farplane,#False,#True)
    Object3D::AddAttribute(*Me,*far)
    Protected *focus = Attribute::New(*Me"focus",Attribute::#ATTR_TYPE_FLOAT,Attribute::#ATTR_STRUCT_SINGLE,Attribute::#ATTR_CTXT_SINGLETON,@*Me\focus,#False,#True)
